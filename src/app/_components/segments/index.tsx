    ...
    <section id="segments" className="border-gray-200 border-y py-12">
      <div className="container mx-auto px-4">
        <div className="mb-16 animate-fade-in text-center">
          <Badge className="mb-4 bg-blue-100 text-blue-800 hover:bg-blue-100">🚀 Segmentos Atendidos</Badge>
          <h2 className="mb-6 font-bold text-4xl text-gray-800 lg:text-5xl">
            Atendemos{' '}
            <span className="bg-gradient-to-r from-blue-800 to-sky-600 bg-clip-text text-transparent">Diversos Setores</span>
          </h2>
